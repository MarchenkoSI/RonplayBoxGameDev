...
{
    public class WordsCVManager : MonoBehaviour
    {
        ...
        private void SetLatinMarkersPipeline()
        {
            ...
            _words_detector =
                new WordsDetector
                (
                    _complex_symbols_detector.GetSamplesSource(),
                    new WordsDetectingParams
                    (
                        60.0f, // pixels
                        -0.7f
                    ),
            ...
            wordsTool.InitWordsTool(_words_detector.GetSamplesSource());
        }
        ...
        private void OnDestroy()
        {
            ...
            DisposeIfCan(_words_detector);
            DisposeIfCan(_words_detector_debug);
        ...
        private WordsDetector _words_detector = null;
        private WordsDetectorDebug _words_detector_debug = null;
    }
}
